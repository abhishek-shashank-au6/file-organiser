...
def organise_folder(args):
    ...
    if os.path.isdir(cwd) is not False:
                ...
                if not entry.is_dir():
                    ...
                    if file_format in FILE_FORMATS:
                        ...
                        if not os.path.exists(directory_path):
                            # Creating the 'Organised' Folder in the Directory
                            os.mkdir(directory_path)
                        dest_folder = os.path.join(directory_path,
                                                   FILE_FORMATS[file_format])
                        if not os.path.exists(dest_folder):
                            # Creating Directories Based On Extensions
        ...
        sys.stdout.write("Organised Path => " + os.path.join(cwd, "Organised"))

    else:
        sys.stdout.write("Invalid Path! Please Enter a Valid Path")
